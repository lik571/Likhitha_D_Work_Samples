...
buildTimeline = function(e){
	...
	// .to('#cta', .5, {transform: 'scale(1.1)', ease: Back.easeOut}, 't2out-=2') 
	// .to('#cta', .3, {transform: 'scale(1)', ease: Back.easeOut}, 't2out-=1.5') 

	// .staggerTo([text2.chars], staggerDuration, {alpha: 0, ease: Sine.easeOut}, staggerDelay, "t2out")
	// .to("#text-2", .4, { left: "-=200"}, "t2out")
