...
function show() {
  ...
  .to([txt1, img_01], 0.5, { autoAlpha: 0, ease: Linear.easeNone, force3D: true }, 'frame1+=4')

  .to([txt2], 0.5, { autoAlpha: 1, ease: Linear.easeNone, force3D: true }, 'frame1+=4.5')
  .to([txt2, img_02], 0.5, { autoAlpha: 0, ease: Linear.easeNone, force3D: true }, 'frame1+=7.5')

  .to([txt3], 0.5, { autoAlpha: 1, ease: Linear.easeNone, force3D: true }, 'frame1+=8')
  .to([txt3, img_03], 0.5, { autoAlpha: 0, ease: Linear.easeNone, force3D: true }, 'frame1+=11')
