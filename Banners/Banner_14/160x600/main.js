...
function init() {
  replaceImageLom()
    ...
    function startAd(){
      ...
      tl.set([obj('cta')], {x:160});

      tl.to([obj('opc')], 0.5, {autoAlpha:0, ease: "Power1.ease"}, "+=0.5");
      tl.to([obj('wrap')], 0.3, {width:0}, "+=3.5");
      tl.to([obj('wrap4')], 0.3, {width:0}, "+=3");
      // tl.to([obj('wrap5')], 0.3, {width:0}, "+=3");

      tl.to([obj('co2')], 0.5, {autoAlpha:1, ease: "Power1.ease"}, "+=0");
      tl.to([obj('wrap7')], 0.3, {width:0}, "+=2");
      tl.to([obj('co2')], 0.5, {autoAlpha:0, ease: "Power1.ease"}, "-=0.3");
      tl.to([obj('cta')], 0.6, {x:0, ease: "Power1.ease"}, "-=0.5");
